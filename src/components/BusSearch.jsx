...
const BusTicketSearch = () => {
  ...
  return (
    <div className="bg-cover bg-center min-h-screen" style={{backgroundImage: "url('https://images.unsplash.com/photo-1519046904884-53103b34b206?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2070&q=80')"}}>
      <div className="bg-black bg-opacity-50 min-h-screen p-4 sm:p-6 md:p-8 flex items-center">
        <div className="max-w-6xl mx-auto w-full">
          ...
          <p className="text-white text-lg sm:text-xl mb-6 sm:mb-8 text-center">Search Bus Ticket Online</p>
          
          <form onSubmit={handleSearch} className="bg-white rounded-lg shadow-lg p-4 sm:p-6 mb-6 sm:mb-8">
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
              <div className="relative">
                ...
                <input 
                  type="text" 
                  placeholder="Origin" 
                  className="w-full p-3 pl-10 border rounded focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-blue-500 transition duration-200"
                  value={origin}
              ...
              <div className="relative">
                ...
                <input 
                  ...
                  className="w-full p-3 pl-10 border rounded text-gray-400 focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-blue-500 transition duration-200"
                  value={date}
          ...
          <div className="text-white text-center">
            <h2 className="text-xl sm:text-2xl font-semibold mb-3 sm:mb-4">Popular Destinations</h2>
            <div className="flex flex-wrap justify-center gap-2 sm:gap-4">
              <span className="bg-white bg-opacity-20 px-3 sm:px-4 py-1 sm:py-2 rounded">Pokhara</span>
              <span className="bg-white bg-opacity-20 px-3 sm:px-4 py-1 sm:py-2 rounded">Kathmandu</span>
              <span className="bg-white bg-opacity-20 px-3 sm:px-4 py-1 sm:py-2 rounded">Chitwan</span>
            </div>
          </div>
        </div>
      </div>
